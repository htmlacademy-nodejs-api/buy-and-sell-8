...
Учебный демо-проект от HTML Academy для 8-го потока профессионального онлайн‑курса «Node.js. Профессиональная разработка REST API».

## Как пользоваться репозиторием

Первый вариант, это изучать коммиты [в веб-интерфейсе GitHub в master-ветке потока](https://github.com/htmlacademy-nodejs-api/buy-and-sell-8).
